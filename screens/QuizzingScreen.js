...
const QuizzingScreen = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        const response = await fetch(`https://6a80-92-236-121-121.ngrok-free.app/api/questions`);
  ...
  const handleSubmitAnswers = async () => {
    ...
    try {
      const response = await fetch('https://6a80-92-236-121-121.ngrok-free.app/api/submit-answers', {
        method: 'POST',
        headers: {
